<?php
/**
 * bs-invent-gaz functions and definitions
 *
...
if ( ! function_exists( 'bs_invent_gaz_setup' ) ) :
	...
	function bs_invent_gaz_setup() {
		 ...
		 * If you're building a theme based on bs-invent-gaz, use a find and replace
		 * to change 'bs-invent-gaz' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'bs-invent-gaz' ),
		) );
...
function bs_invent_gaz_scripts() {
	...
	wp_enqueue_script( 'bs-invent-gaz-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
