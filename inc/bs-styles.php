...
function bs_invent_gaz_scripts() {
	...
	wp_enqueue_script( 'bs-invent-gaz-slick', get_template_directory_uri() . '/assets/libs/slick/slick/slick.min.js', array('jquery'), nul, true );
	wp_enqueue_script( 'bs-invent-gaz-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), nul, true );

	wp_enqueue_script( 'bs-invent-gaz-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array('jquery'), nul, true );
